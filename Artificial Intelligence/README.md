...
# Реализация: 
Намерих интересни данни на [кадъл](https://www.kaggle.com/datasets). Информация от HR фирми за различни служители, кога и при какви условия напускат. Избрах няколко алгоритъма с които да ги анализирам и след това да сравня резултатите, кой най-добре предвижда рискови служители.
